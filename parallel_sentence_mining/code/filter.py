...
def getArguments():
  ...
  parser.add_argument('-th', '--threshold', default=2.5, type=float, help='In case of static method: threshold value; dynamic: weight (lambda) of similarity standard deviation: th = mean(S) + lambda*std(S)')

  return parser.parse_args()


def main(input, output, method='dynamic', threshold=2.5):
