...
### MODIFY PATH ###
PRETRAINING_PATH = "../pretraining_test/modelling/output-hsb-para-cs"
...
def parse_args():
    ...
    parser.add_argument(
        ...
        required=True,
        # 👉 hier LASER ergänzen
        choices=["xlmr", "glot500", "pretrained", "labse", "sonar", "laser", "qwen3", "llama31"],
...
def to_xlmr_sentence_embeddings(path, sentence_list, model_name, start_i=0):
    if model_name == "xlmr":
        ...
        print(f"Using pretrained model from: {PRETRAINING_PATH}")
